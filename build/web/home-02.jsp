<%-- 
    Document   : home-02
    Created on : Jul 6, 2022, 6:06:01 AM
    Author     : Acers
--%>
...
<html lang="en">
    ...
    <body class="animsition">
        ...
        <%@include file="includes/mobile2.jsp" %>
                ...
                <div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
                    ...
                    <div class="sidebar-gallery w-full">
                        ...
                        <p class="stext-108 cl6 p-t-27">
                            Quan's shop is the place where have new and fashionable clothes
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="tab01">
                    ...
                    <div class="tab-content p-t-50">
                        ...
                        <div class="flex-c-m flex-w w-full p-t-45">
                            <a href="ProductController" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
                                Load More
                            </a>
                        </div>
                    </div>
